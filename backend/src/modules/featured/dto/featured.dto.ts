...
export class CreateFeaturedContentDto {
  ...
  @ApiPropertyOptional({
    description: "Collection ID (if featuring a collection)",
  })
  @IsOptional()
  @IsUUID()
  collectionId?: string;
  ...
  @ApiPropertyOptional({
    description: "End date (ISO 8601, null for indefinite)",
  })
  @IsOptional()
  @IsDateString()
  endDate?: string;
  ...
  @ApiPropertyOptional({
    description: "Whether featured content is active",
    default: true,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    description: "Priority (higher = more prominent)",
    default: 0,
  })
  @IsOptional()
  @Type(() => Number)
