...
export class CreateCollectionDto {
  ...
  @ApiPropertyOptional({ description: 'Whether collection is public', default: true })
  @IsOptional()
  @IsBoolean()
  isPublic?: boolean;
}
...
export class AddStoryToCollectionDto {
  ...
  @ApiPropertyOptional({ description: 'Curator note about why this story is included' })
  @IsOptional()
  @IsString()
  @MaxLength(500)
  curatorNote?: string;
...
export class CollectionQueryDto {
  ...
  @ApiPropertyOptional({ description: 'Sort by field', enum: ['createdAt', 'followerCount', 'name'] })
  @IsOptional()
  @IsString()
