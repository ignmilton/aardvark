...
export class MobileController {
  ...
  async unregisterPushToken(@Request() req: any, @Body() body: { token: string }) {
  ...
  async verifyIosReceipt(@Request() req: any, @Body() dto: VerifyIosReceiptDto) {
  ...
  @ApiResponse({ status: 200, description: 'Verification result' })
  async verifyAndroidReceipt(@Request() req: any, @Body() dto: VerifyAndroidReceiptDto) {
