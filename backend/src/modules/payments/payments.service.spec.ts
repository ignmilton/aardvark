...
describe('PaymentsService', () => {
  ...
  describe('getOrCreateCustomer', () => {
    ...
    it('should create new customer if not found', async () => {
      ...
      const result = await service.getOrCreateCustomer('user-456', 'new@example.com', 'Test User');
  ...
  describe('createPaymentIntent', () => {
    it('should create payment intent with correct parameters', async () => {
      ...
      const result = await service.createPaymentIntent('cus_123', 1000, 'usd', { bundleId: 'bundle-1' });
  ...
  describe('createSubscriptionCheckoutSession', () => {
    it('should create subscription checkout session', async () => {
      const session = { id: 'cs_sub_123', url: 'https://checkout.stripe.com/sub' };
      mockStripe.checkout.sessions.create.mockResolvedValue(session);
  ...
  describe('Stripe Connect', () => {
    describe('createConnectAccount', () => {
      it('should create express connect account', async () => {
        ...
        const result = await service.createConnectAccount('author-123', 'author@example.com', 'US');
  ...
  describe('constructWebhookEvent', () => {
    it('should construct and verify webhook event', () => {
      ...
      const result = service.constructWebhookEvent('payload', 'sig_xxx', 'whsec_xxx');

      expect(result).toEqual(event);
      expect(mockStripe.webhooks.constructEvent).toHaveBeenCalledWith('payload', 'sig_xxx', 'whsec_xxx');
    });
    ...
    it('should throw BadRequestException on invalid signature', () => {
      ...
      expect(() => service.constructWebhookEvent('payload', 'bad_sig', 'whsec_xxx')).toThrow(
        BadRequestException,
      );
    });
  });
  ...
  describe('createRefund', () => {
    it('should create refund for payment intent', async () => {
      ...
      const result = await service.createRefund('pi_123', 1000, 'requested_by_customer');
